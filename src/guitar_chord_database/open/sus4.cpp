...
const open_diagram_map& sus4_open()
{
    ...
    static const open_diagram_map db =
    {
        ...
        { { NoteEnum::C, TRIAD_SUS4_NO5 | (1ULL << 10)},
            {
            // x     
            // =========== 
            // | 1 1 1 1 1
